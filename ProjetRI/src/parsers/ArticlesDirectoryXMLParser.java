...
public class ArticlesDirectoryXMLParser {
    ...
    public void parseDirectory(String directoryPath) {
        System.out.println("Begin of directory's parsing.\n");
...
//                System.out.println(articleParser.getText() + " " + articleParser.getId());
    ...
    public static void main(String[] args) {
        new ArticlesDirectoryXMLParser().parseDirectory("../../coll10");
    }
}
